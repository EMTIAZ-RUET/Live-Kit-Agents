...
# - langchain-groq
# - langgraph
# - livekit-agents[silero,langchain,deepgram,turn_detector]
...
# a simple StateGraph with a single Groq Llama node
...
async def entrypoint(ctx: JobContext):
    ...
    agent = Agent(
        instructions="You are a helpful voice AI assistant. You eagerly assist users with their questions by providing information from your extensive knowledge. Your responses are concise, to the point, and without any complex formatting or punctuation including emojis, asterisks, or other symbols. You are curious, friendly, and have a sense of humor.",
